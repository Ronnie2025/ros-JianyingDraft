...
`schema_version: 1`、`name`、`canvas: {width,height,fps}`、`assets`、`tracks` 必填。画幅由宽高确定，fps 为 24/25/30/50/60 整数。轨道按数组从底到顶排列，类型为 video/audio/text；所有轨道名称、所有片段 ID、所有素材 ID 各自唯一。
